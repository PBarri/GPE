 ...
 *
 */
@FacesRenderer(componentFamily = OverlayPanel.COMPONENT_FAMILY, rendererType=OverlayPanel.DEFAULT_RENDERER)
@Deprecated
public class ExtendedOverlayPanelRenderer extends CoreRenderer {
    ...
    protected void encodeScript(FacesContext context, OverlayPanel panel) throws IOException {
        ...
        wb.initWithDomReady("ExtendedOverlayPanel", panel.resolveWidgetVar(), clientId)
            .attr("target", target)
            ...
            .attr("appendTo", panel.getAppendTo())
